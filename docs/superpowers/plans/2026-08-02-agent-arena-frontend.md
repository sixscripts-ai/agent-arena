...
- [ ] **Step 1: appwrite.ts** — client, account helpers (signup, login, logout, jwt)
- [ ] **Step 2: api.ts** — `apiGet/Post` with Bearer JWT; streamBattle SSE parser
- [ ] **Step 3: AuthProvider** — session restore, jwt refresh, useAuth hook
- [ ] **Step 4: Commit**
...
- [ ] **Step 1: Fetch GET /formats (with optional auth)**
- [ ] **Step 2: Filter by engine**
- [ ] **Step 3: Commit**
...
- [ ] **Step 1: List providers (host free first)**
- [ ] **Step 2: Add form with model_name**
- [ ] **Step 3: Commit**
...
- [ ] **Step 1: Format select, model multi-select (len = playable roles), options**
- [ ] **Step 2: POST /battles → redirect /battles/[id]**
- [ ] **Step 3: Commit**
...
- [ ] **Step 1: SSE consumer + event log UI**
- [ ] **Step 2: Stop + Save buttons**
- [ ] **Step 3: Commit**
...
- [ ] **Step 1: Leaderboard scopes**
- [ ] **Step 2: History via GET /battles?saved=true (add endpoint if missing)**
- [ ] **Step 3: Commit**
...
- [ ] **Step 1: Loading/error states, toasts**
- [ ] **Step 2: Document env + Appwrite platform setup**
